...
surv_plot <- ggsurvplot(km_data, 
                        ...
                        pval=TRUE,
                        pval.method = TRUE,
                        pval.method.coord = c(0.02, 0.13),
                        pval.method.size=3.3,
                        pval.size = 3,
...
plt_ext <- surv_plot$plot + 
  ...
  theme(plot.tag.position = c(0.1, 1), 
        plot.margin = unit(c(0.2, 0.2, 0.2, 0.7), 
                           units = "cm")) + 
  geom_tile(data=data.frame(x=2, y=0.115, w=5, h=0.1), 
...
### save the plot ###
#####################
ggsave(plot=final, filename="km_poster.pdf", width = 10, height = 7.5, units = "in")
ggsave(plot=final, filename="km_poster.png", width = 10, height = 7.5, units = "in")
